 ...
 */
export const indexTemplateHtml = `<div class="carousel" :style="containerStyle"><div class="main" :style="mainStyle" @touchstart="touchstart($event)" @touchmove="touchmove($event)" @touchend="touchend($event)"><ul ref="ul" :style="ulStyle" @mouseenter="pause()" @mouseleave="start()"><li v-for="(item, i) in data" :key="i" v-if="i >= currentIndex - actualCount && i < currentIndex + actualCount * 2" :style="liStyle"><component :is="item.component" :data="item.data"></component></li></ul></div><div class="left" :style="leftStyle" @click="moveLeft(actualCount)" @mouseenter="mouseenterLeft()" @mouseleave="mouseleaveLeft()"></div><div class="right" :style="rightStyle" @click="moveRight(actualCount)" @mouseenter="mouseenterRight()" @mouseleave="mouseleaveRight()"></div></div>`;
